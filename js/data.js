    ...
    var companies = [
        ...
        },
        {
            id: 'zemen-bus', name: 'Zemen Bus', slug: 'zemen-bus', logo: 'assets/images/companies/zemen-bus-logo.svg', coverImage: 'assets/images/companies/cover-zemen-bus.svg', verified: true, tagline: 'Premier service on the eastern corridor to Dire Dawa, Harar and Jijiga.', description: 'Zemen Bus is known for its premium coaches on the eastern corridor, running from Addis Ababa to Dire Dawa, Harar and Jijiga with a focus on service and on-time performance.', rating: 4.6, reviewCount: 910, founded: 2009, headOffice: 'Addis Ababa, Bole', phone: '+251 11 778 1140', phones: ['+251 11 778 1140', '+251 25 112 2144'], email: 'info@zemenbus.example.com', website: 'https://zemenbus.example.com', destinations: ['Dire Dawa', 'Harar', 'Jijiga', 'Aweday'], amenities: ['Air Conditioning', 'Reclining Seats', 'Charging', 'Luggage', 'Wi-Fi'], busCount: 18, fleet: [
                { model: 'Neoplan Skyliner', type: 'Standard', seats: 51, image: 'assets/images/buses/bus-standard.svg', amenities: ['A/C', 'Reclining Seats', 'Charging'], description: 'Comfort-led coach used for long eastern corridors with several midday stops.' },
                { model: 'Mercedes-Benz Tourismo', type: 'Standard', seats: 51, image: 'assets/images/buses/bus-standard.svg', amenities: ['A/C', 'Wi-Fi', 'Charging'], description: 'Executive coach geared toward higher comfort and less crowding.' }
            ], popularRoutes: [
        ...
        {
            id: 'odaa-bus', name: 'ODAA Bus', slug: 'odaa-bus', logo: 'assets/images/companies/odaa-bus-logo.svg', coverImage: 'assets/images/companies/cover-odaa-bus.svg', verified: true, tagline: 'Reliable routes to Jimma, Hawassa and the western belt.', description: 'ODAA Bus covers fast-growing southern and western routes, delivering value and predictable departures to Jimma, Hawassa and nearby destinations.', rating: 4.4, reviewCount: 610, founded: 2015, headOffice: 'Addis Ababa, Kolfe', phone: '+251 11 442 9090', phones: ['+251 11 442 9090', '+251 47 112 1122'], email: 'info@odaa.example.com', website: 'https://odaa.example.com', destinations: ['Jimma', 'Hawassa', 'Dilla', 'Wolisso'], amenities: ['Air Conditioning', 'Charging', 'Luggage', 'Reclining Seats'], busCount: 19, fleet: [
                { model: 'Yutong ZK6122H9', type: 'Standard', seats: 51, image: 'assets/images/buses/bus-standard.svg', amenities: ['A/C', 'Reclining Seats', 'Charging'], description: 'Practical coach with good legroom and frequent route coverage.' },
                { model: 'Foton AUV BJ6129', type: 'Standard', seats: 51, image: 'assets/images/buses/bus-standard.svg', amenities: ['A/C', 'Charging', 'Luggage'], description: 'Smaller coach for frequent southern schedules and budget travelers.' }
            ], popularRoutes: [
        ...
        },
        {
            id: 'abay-bus', name: 'Abay Bus', slug: 'abay-bus', logo: 'assets/images/companies/abay-bus-logo.svg', coverImage: 'assets/images/companies/cover-abay-bus.svg', verified: true, tagline: 'Budget-friendly connections to the north-west.', description: 'Abay Bus is known for dependable buses on the Addis Ababa – Bahir Dar corridor with a strong value-for-money proposition and regular schedules.', rating: 4.2, reviewCount: 420, founded: 2011, headOffice: 'Addis Ababa, Megenagna', phone: '+251 11 554 7733', phones: ['+251 11 554 7733', '+251 58 220 7711'], email: 'info@abaybus.example.com', website: 'https://abaybus.example.com', destinations: ['Bahir Dar', 'Gondar', 'Dessie'], amenities: ['Air Conditioning', 'Luggage', 'Charging'], busCount: 11, fleet: [
                { model: 'Yutong ZK6107H', type: 'Standard', seats: 51, image: 'assets/images/buses/bus-standard.svg', amenities: ['A/C', 'Luggage'], description: 'Reliable standard coach used on popular north-west routes.' }
            ], popularRoutes: [
        ...
        {
            id: 'ethio-bus', name: 'Ethio Bus', slug: 'ethio-bus', logo: 'assets/images/companies/ethio-bus-logo.svg', coverImage: 'assets/images/companies/cover-ethio-bus.svg', verified: true, tagline: 'Fast route coverage to the south and lake regions.', description: 'Ethio Bus serves key southern destinations with focused departures and dependable service on fast-moving routes to Hawassa and nearby towns.', rating: 4.1, reviewCount: 318, founded: 2016, headOffice: 'Addis Ababa, Meskel Square', phone: '+251 11 445 8922', phones: ['+251 11 445 8922', '+251 46 200 8811'], email: 'info@ethiobus.example.com', website: 'https://ethiobus.example.com', destinations: ['Hawassa', 'Shashamane', 'Dilla', 'Arba Minch'], amenities: ['Air Conditioning', 'Luggage', 'Charging'], busCount: 9, fleet: [
                { model: 'King Long XMQ6898', type: 'Standard', seats: 51, image: 'assets/images/buses/bus-standard.svg', amenities: ['A/C', 'Luggage'], description: 'Compact route vehicle used for a quick turn-around service to the south.' }
            ], popularRoutes: [
        ...
        {
            id: 'liyu-bus', name: 'Liyu Bus', slug: 'liyu-bus', logo: 'assets/images/companies/liyu-bus-logo.svg', coverImage: 'assets/images/companies/cover-liyu-bus.svg', verified: true, tagline: 'Executive comfort on the north corridor to Mekelle.', description: 'Liyu Bus offers premium comfort and regular departures for the Addis Ababa – Mekelle corridor, focusing on travelers wanting more space and a polished service.', rating: 4.6, reviewCount: 730, founded: 2014, headOffice: 'Addis Ababa, Piassa', phone: '+251 11 990 2133', phones: ['+251 11 990 2133', '+251 34 556 1099'], email: 'info@liyubus.example.com', website: 'https://liyubus.example.com', destinations: ['Mekelle', 'Axum', 'Shire'], amenities: ['Air Conditioning', 'Wi-Fi', 'Charging', 'Luggage', 'Meals'], busCount: 13, fleet: [
